...
class WxHongBaoHelper
{
	...
	private $pem2;
	private $pem3;
	function __construct($paykey,$pem1,$pem2,$pem3)
	{
		$this->paykey=$paykey;
		$this->pem1=$pem1;
		$this->pem2=$pem2;
	...
	function check_sign_parameters(){
		//file_put_contents('log.txt','<br/>'.time().'-'.print_r($this->parameters,true),FILE_APPEND);
	...
	*/
	...
	function curl_post_ssl($url, $vars, $second=30,$aHeader=array())
	{
		...
		//curl_setopt($ch,CURLOPT_SSLCERT,YYUC_FRAME_PATH.YYUC_PUB.'/pubs2015/'.'apiclient_certdb85e2590b6109813dafa101ceb2faeb.pem');
 		//curl_setopt($ch,CURLOPT_SSLKEY,YYUC_FRAME_PATH.YYUC_PUB.'/pubs2015/'.'apiclient_keydb85e2590b6109813dafa101ceb2faeb.pem');
 		//curl_setopt($ch,CURLOPT_CAINFO,YYUC_FRAME_PATH.YYUC_PUB.'/pubs2015/'.'rootcadb85e2590b6109813dafa101ceb2faeb.pem');
		curl_setopt($ch,CURLOPT_SSLCERT,$this->pem1);
		curl_setopt($ch,CURLOPT_SSLKEY,$this->pem2);
		curl_setopt($ch,CURLOPT_CAINFO,$this->pem3);

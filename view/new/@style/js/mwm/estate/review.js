...
FCAPP.REVIEW = FCAPP.REVIEW || {
    ...
    loadReviewList: function() {
        ...
        //reviewResult({"msg":"ok","ret":0,"user":{"content":"\u5ea6\u5047\u51a0\u519b","count":30,"id":38},"top":[{"content":"\u5ea6\u5047\u51a0\u519b","count":30,"id":38},{"content":"\u5ab2\u7f8e\u767d\u6ee9","count":25,"id":39},{"content":"\u9b45\u529b\u6c99\u6ee9","count":17,"id":40},{"content":"\u5962\u534e\u914d\u5957","count":12,"id":41},{"content":"\u8d34\u5fc3\u7269\u7ba1","count":10,"id":42},{"content":"\u5e38\u4f4f\u9996\u9009","count":6,"id":43}],"sum":100});
    },
    ...
    sendReview: function() {
        ...
        if (isNaN(id) || review.length < 2 || /[^\u4e00-\u9FFF]/g.test(review)) {
            REVIEW.showTips(true, {
                msg: '请输入四个汉字的印象名称'
            });
            R.popTips.hide();
            ...
            $.ajax({
                url: 'review.html?typ=setres&'+$.param(data),
                dataType: 'json',
                success:function(m){
                	sendReviewResult(m);
                }
            });
            //sendReviewResult({"msg":"ok","ret":0,"user":{"content":"\u672a\u5b8c\u5168\u4fc4","count":1,"id":201},"top":[{"content":"\u5ea6\u5047\u51a0\u519b","count":29,"id":38},{"content":"\u5ab2\u7f8e\u767d\u6ee9","count":25,"id":39},{"content":"\u9b45\u529b\u6c99\u6ee9","count":17,"id":40},{"content":"\u5962\u534e\u914d\u5957","count":12,"id":41},{"content":"\u8d34\u5fc3\u7269\u7ba1","count":10,"id":42},{"content":"\u5e38\u4f4f\u9996\u9009","count":6,"id":43}],"sum":100});
        }
    },
    sendReviewResult: function(res) {
        ...
        if (res.ret == 0) {
            ...
            if (count < 1) {
                ...
                $('#userReview').html('<em>我的印象<i>' + R.userReviewText.substr(0, 4) + '</i>与' + count + '%粉丝相同</em>');
            }
        } else {
            var msg = '哎呀~出了点儿小问题，点击刷新试试吧~';
            if (res.ret == -100) {

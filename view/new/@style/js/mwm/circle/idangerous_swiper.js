    ...
    _this.init = function(force, forceCalcSlides) {
        ...
        if (params.slidesPerView==='auto') {
            ...
            if (params.calculateHeight) {
				...
				var containerHeight = _this.height = slideHeight;
                if (!isH) _this.container.style.height= containerHeight+'px';
            ...
            wrapper.style.width = wrapperWidth+'px';
            if(!isH) wrapper.style.height = wrapperHeight+'px';
            var slideLeft = 0;
            _this.snapGrid = [];
            _this.slidesGrid = [];
            for (var i=0; i<_this.slides.length; i++) {
				...
				if(!isH) _this.slides[i].style.height = slideHeight+'px';
            }
